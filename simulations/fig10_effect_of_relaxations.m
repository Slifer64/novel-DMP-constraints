...
data{length(data)+1} = ...
    struct('Time',Time, 'Pos',P_data, 'Vel',dP_data, 'Accel',ddP_data, 'linestyle','-', ...
    'color',[0.72 0.27 1], 'legend',['slack on'], 'plot3D',true, 'plot2D',true);
...
data{length(data)+1} = ...
    struct('Time',Time, 'Pos',P_data, 'Vel',dP_data, 'Accel',ddP_data, 'linestyle','-', ...
    'color',[0 0.7 0], 'legend',['slack off'], 'plot3D',true, 'plot2D',true);
...
data{length(data)+1} = ...
    struct('Time',Time, 'Pos',P_data, 'Vel',dP_data, 'Accel',ddP_data, 'linestyle',':', ...
    'color',[0.85 0.33 0.1], 'legend',['slack off + augment limits'], 'plot3D',true, 'plot2D',true);
