...
%     vel_lim = vel_lim + repmat(max_slack_violation(2)*[-1 1], n_dof, 1);    
%     accel_lim = accel_lim + repmat(max_slack_violation(3)*[-1 1], n_dof, 1);
%     slack_limits = 0*slack_limits;
%     slack_gains = 0*slack_gains;
